  ...
  return (
    <section className="relative h-auto md:min-h-auto  mt-16 md:mt-0 bg-home-desktop no-repeat bg-cover bg-[center_top]">
      <div className="container h-full md:min-h-screen flex flex-col justify-center items-center pt-8 xs:pt-10  ">
        <h1 className="text-white text-xl md:text-4xl font-MorabbaBold">
          <Typewriter
            onInit={(typewriter) => {
              typewriter
        ...
        <h2 className="text-white text-base md:text-2xl pt-8 mb-2 leading-7.5 font-DanaDemiBold text-center">
        ...
        <div className="relative w-full md:w-2/3 mx-auto space-y-6 mt-7 sm:mt-12 lg:mt-14 mb-10 lg:mb-14 my-14 z-30">
          <div className="flex items-center justify-between gap-x-5 md:gap-x-8 p-1.5 sm:p-2.5 bg-white rounded-full border border-transparent focus-within:border-neutral-200 transition-all">
            <input
              autoComplete="off"
              name="s"
              data-nval="401ee82574"
              id="searchbox-input"
              type="text"
              value={searchValue}
        ...
        <div className="flex w-full justify-evenly mb-8">
          ...
          <div className="flex flex-col gap-y-2 items-center">
            <svg
              ...
              viewBox="0 0 512 512"
              className="text-white fill-current w-15 h-15 md:w-22 md:h-22"
            >
            ...
            <span className="text-white text-xs md:text-lg font-MorabbaBold text-center">
