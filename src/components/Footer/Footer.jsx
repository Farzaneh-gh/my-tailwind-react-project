...
function Footer() {
  return (
    <div className=" text-gray-300 bg-zinc-700  md:pt-15.5 px-4 md:px-6 py-8 md:pb-12">
      <div className=" flex justify-between flex-col md:flex-row md:w-[98%] xl:w-[90%] mx-auto border-b border-gray-300 pb-10  ">
        ...
        <div className="md:mt-6.5 pr-4">
          ...
          <div className="md:text-xl flex flex-col  gap-5">
            <div className=" text-orange-300 flex">
              ...
              <span className="mr-3 font-DanaMedium">info@sabzlearn.ir</span>
            </div>

            <div className="flex md:text-xl font-DanaMedium">
              <svg className="w-5 h-5 md:w-6 md:h-6">
                <use href="#icon-phoneSimple" />
              </svg>
              <span className="mr-3">0902 123 6628</span>
              <span className="mr-6">021 - 6789012</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex mt-10 gap-x-2.5 items-center md:w-[98%] xl:w-[90%] mx-auto ">
        <div className=" shrink-0 w-8 h-8  border-1 border-gay-100 rounded-full flex justify-center items-center">
          <div className="w-5 h-5 border-1 border-gay-100 rounded-full flex justify-center items-center">
            <div className="w-2 h-2  bg-orange-300 rounded-full"></div>
          </div>
        </div>
        <p className="font-DanaMedium text-xs">
