  ...
  return (
    <>
              ...
              <li key={index} className="relative group">
                ...
                >
                  ...
                  {menu.submenus.length > 0 && (
                    <svg className="w-4 h-4 inline-block mr-1.5">
        ...
        <div className="flex text-orange-200 items-center gap-x-3 md:gap-x-5 xl:gap-x-6">
          ...
          {isLoggedIn ? (
            <div className="relative group">
              ...
              <ul
                className="flex flex-col absolute transition-all delay-75 w-52 h-auto border-t-3 top-full left-0 invisible opacity-0 group-hover:visible group-hover:opacity-100 border-orange-300
              ...
              >
                <li>
                  ...
                  >
                    ...
                    <span className="hidden xl:inline-block ">پروفایل</span>
                  </Link>
                </li>
                <li>
                  <button
      ...
      <header className="lg:hidden bg-white dark:bg-zinc-700 w-full h-16 flex items-center justify-between px-4 py-3 fixed top-0 right-0 left-0 z-50">
        ...
        <div onClick={openMobileCartSidebarHandler}>
          <svg className="w-6 h-6 text-zinc-700 dark:text-white">
            <use href="#icon-shopping-cart" />
          </svg>
        </div>
