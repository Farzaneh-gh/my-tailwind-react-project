  ...
  return (
    <div className="course flex flex-col bg-white dark:bg-zinc-700 rounded-xl">
      ...
      <div className="flex-grow px-4.5 pt-4 pb-3">
        <h3 className="font-DanaDemiBold text-lg md:text-xl min-h-14 line-clamp-2 mb-3 text-zinc-700 dark:text-white">
          <a href="#">{course.name} </a>
        </h3>

        <p className="text-base  line-clamp-2 min-h-12 max-h-12 text-gray-700 pb-3 dark:text-gray-200">
          {course.description}{" "}
        </p>
      </div>
