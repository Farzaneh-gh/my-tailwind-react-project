...
function Login() {
  ...
  const handleSignIn = async (data) => {
    ...
    try {
      ...
      swal({ title: "خطا", text: err.message, icon: "error", button: "باشه" });
    }
  };
    ...
    <main className="flex-center flex-col relative px-4 py-6 min-h-screen bg-gray-100 font-Dana ">
      ...
      <div className="max-w-[380px] w-full pt-5 pb-6 px-6 text-center bg-white dark:bg-zinc-800 rounded-2xl shadow-lg">
        <div className="user-data">
          <h4 className="font-MorabbaBold text-xl mb-4 sm:mb-4.5">ورود با ایمیل</h4>
          <p className="mb-5">
            حساب کاربری ندارید؟&nbsp;
            <Link
              to="/register"
          ...
          >
            <div className="relative">
              ...
              {errors.username && (
                <span className="text-red-500 text-xs mt-2 block text-right mr-3">
